...
public class PredictionTF {
    ...
    public int[] getPredict(Bitmap bitmap) {
        float[] inputdata = bitmapToFloatArray(bitmap,100, 100);//需要将图片缩放带28*28
